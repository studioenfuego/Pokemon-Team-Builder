...
export const POKEMON_DATA = {
    ...
    "IRONTHREADS": { name: "Iron Treads", types: ["Ground", "Steel"], image_path: "Front/IRONTREADS.png" },
    ...
    "OGERPON_TEAL_MASK": { name: "Teal Mask Ogerpon", types: ["Grass"], image_path: "Front/OGERPON.png" },
    "OGERPON_HEARTHFLAME_MASK": { name: "Hearthflame Mask Ogerpon", types: ["Fire", "Grass"], image_path: "Front/OGERPON_2.png" },
    "OGERPON_CORNERSTONE_MASK": { name: "Cornerstone Mask Ogerpon", types: ["Rock", "Grass"], image_path: "Front/OGERPON_3.png" },
    "OGERPON_WELLSPRING_MASK": { name: "Wellspring Mask Ogerpon", types: ["Water", "Grass"], image_path: "Front/OGERPON_1.png" },
